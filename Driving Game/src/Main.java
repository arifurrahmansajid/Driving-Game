...
public class Main  extends JFrame {
	...
	class sprit extends JPanel
	{
		...
		ImageIcon youWinpic = new ImageIcon( Main.class.getResource("/resources/winner.gif"));
		Image youWin = youWinpic.getImage();
		
		ImageIcon youLosepic = new ImageIcon( Main.class.getResource("/resources/gameOver.gif"));
